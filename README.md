...
Portable skill files any agent can load — plain markdown, usable in a skills folder, a rules file, or pasted into a coding assistant's custom instructions:
- [noyesman](skills/noyesman.md) - sycophancy calibration for AI reviews: verify specific claims, tier findings by real stakes, and say "this is fine" only when it actually is
---
...
│
├── skills/                            # Portable skills any agent can load
│   └── noyesman.md                    # Sycophancy calibration for AI reviews
│
├── risk-scanner/
│   ├── README.md
